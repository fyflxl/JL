...
*****/
#ifndef TCFG_UNISOUND_ENABLE
#define TCFG_UNISOUND_ENABLE 0
#endif

////  如果clock_fix 为0 就按照配置设置时钟，如果有值就固定频率
#if (TCFG_MIC_EFFECT_ENABLE|| TCFG_UNISOUND_ENABLE)
...
const struct clock_type  clock_enum[] = {
    ...
    { BT_IDLE_CLOCK     	, (12), "	BT_IDLE_CLOCK      " },
#ifndef CONFIG_SOUNDBOX_FLASH_256K
    { MUSIC_IDLE_CLOCK  	, (12), "	MUSIC_IDLE_CLOCK   " },
    { FM_IDLE_CLOCK     	, (12), "	FM_IDLE_CLOCK      " },
    { LINEIN_IDLE_CLOCK 	, (64), "	LINEIN_IDLE_CLOCK  " },
    ...
    { WATCH_SPORT_CLK, (50),	"WATCH_SPORT_CLK"   },
#ifndef CONFIG_SOUNDBOX_FLASH_256K
    ...
    {RCSP_ACTION_CLK, (160),	"RCSP_ACTION_CLK"   },

#ifdef CONFIG_ADAPTER_ENABLE
    {ADAPTER_PROCESS_CLK, (64),	"ADAPTER_PROCESS_CLK"   },
#endif

    {SMART_VOICE_CLK, (32),	"SMART_VOICE_CLK"   },

#if TCFG_BROADCAST_ENABLE
    {BROADCAST_CLK, (12),	"BROADCAST_CLK"   },
    {BROADCAST_ENC_CLK, (32),	"BROADCAST_ENC_CLK"   },
    {BROADCAST_DEC_CLK, (32),	"BROADCAST_DEC_CLK"   },
#endif
};
