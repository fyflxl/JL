...
//*********************************************************************************//
/*软件IIC设置*/
#ifndef TCHFG_SOFT_I2C_ENABLE
#define TCHFG_SOFT_I2C_ENABLE               ENABLE_THIS_MOUDLE                     //软件IIC使能
#endif
...
#if (TCFG_TEST_BOX_ENABLE) && (defined AUDIO_PCM_DEBUG)
