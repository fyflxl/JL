...
struct sound_pcm_underrun_params;
...
#define SOUND_PCM_SET_DMA_UNDERRUN          _IOW('P', 9, sizeof(struct sound_pcm_underrun_params)) /* Get硬件读指针 */
...
struct sound_pcm_underrun_params {
    ...
    u16 time;
    void *private_data;
    void (*handler)(void *priv, int arg);
};
...
struct sound_pcm_runtime {
    ...
    u16 underrun_frames;
    void *underrun_data;
    void (*underrun_handler)(void *priv, int arg);
