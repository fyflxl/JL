...
/* --------------------------------------------------------------------------*/
/**
 * @brief argc 为 Q_CALLBACK 时
 * @param argv[0] : msg[]个数，单位int
 * @param msg[0] : Function回调函数
 * @param msg[1] 低8位 : Function参数个数
 * @param msg[1] bit 8 : Function参数个数+1，同时返回值存到argv[参数个数]
 * @param msg[1] bit 9 : Function参数个数+1，同时post信号量：argv[参数个数]
 * @param msg[1] bit10 : Function为(int, int, int*)多参数函数
 * @param msg[2] : 可能Function第一个参数
 * @param msg[3] : 可能Function第二个参数
 *
 * @return 0: Nothing,  1: callback
 */
/* ----------------------------------------------------------------------------*/
