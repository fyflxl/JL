...
const char *tone_table[] = {
    ...
    [IDEX_TONE_UNISOUND] 		= TONE_RES_ROOT_PATH"tone/unisound.*",
    [IDEX_TONE_SPEECH_START]	= TONE_NORMAL,//TONE_RES_ROOT_PATH"tone/speech.*",
    [IDEX_TONE_BROADCAST_OPEN]  = TONE_RES_ROOT_PATH"tone/bc_open.*",
    [IDEX_TONE_BROADCAST_CLOSE]  = TONE_RES_ROOT_PATH"tone/bc_close.*",
};
