...
#if (TCFG_USER_BLE_ENABLE | LEA_BIG_CTRLER_TX_EN | LEA_BIG_CTRLER_RX_EN)
        | BT_MODULE_LE
#endif//TCFG_USER_BLE_ENABLE
        ;
...
const int CONFIG_A2DP_DELAY_TIME            = 300;
const int CONFIG_A2DP_DELAY_TIME_LO         = 100;
#ifdef CONFIG_A2DP_GAME_MODE_DELAY_TIME
const int CONFIG_A2DP_SBC_DELAY_TIME_LO     = CONFIG_A2DP_GAME_MODE_DELAY_TIME + 25;
#else
...
#if ((TCFG_USER_EMITTER_ENABLE == 1) && (TCFG_BD_NUM == 2))
...
const int config_btctler_le_hw_nums = TRANS_MULTI_BLE_CONNECT_NUMS;
const int config_btctler_le_rx_nums = (TRANS_MULTI_BLE_CONNECT_NUMS * 3) + 3;
const int config_btctler_le_acl_packet_length = 27;
const int config_btctler_le_acl_total_nums = (TRANS_MULTI_BLE_CONNECT_NUMS * 3) + 3;
const int config_btctler_le_master_multilink = (TRANS_MULTI_BLE_MASTER_NUMS > 1);
const int config_btctler_le_afh_en = (TRANS_MULTI_BLE_MASTER_NUMS > 0);
...
const char log_tag_const_i_LL_ISO AT(.LOG_TAG_CONST) = CONFIG_DEBUG_LIB(0);
const char log_tag_const_d_LL_ISO AT(.LOG_TAG_CONST) = CONFIG_DEBUG_LIB(0);
const char log_tag_const_w_LL_ISO AT(.LOG_TAG_CONST) = CONFIG_DEBUG_LIB(1);
const char log_tag_const_e_LL_ISO AT(.LOG_TAG_CONST) = CONFIG_DEBUG_LIB(0);
...
const char log_tag_const_d_LL_BIS AT(.LOG_TAG_CONST) = CONFIG_DEBUG_LIB(0);
...
const char log_tag_const_v_TWS AT(.LOG_TAG_CONST) = CONFIG_DEBUG_LIB(1);
