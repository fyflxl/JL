...
const char log_tag_const_v_UNISOUND AT(.LOG_TAG_CONST) = FALSE;
const char log_tag_const_i_UNISOUND AT(.LOG_TAG_CONST) = TRUE;
const char log_tag_const_d_UNISOUND AT(.LOG_TAG_CONST) = FALSE;
const char log_tag_const_w_UNISOUND AT(.LOG_TAG_CONST) = FALSE;
const char log_tag_const_e_UNISOUND AT(.LOG_TAG_CONST) = TRUE;
