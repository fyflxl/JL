...
#if ((TCFG_BLE_DEMO_SELECT == DEF_BLE_DEMO_RCSP_DEMO) && RCSP_MULTI_BLE_SLAVE_NUMS && RCSP_MULTI_BLE_EN)
#define SMBOX_MUTIL_ROLE_IS_SERVER      1
#include "ble_rcsp_multi_trans.h"
...
void smbox_trans_cbk_sm_packet_handler(uint8_t packet_type, uint16_t channel, uint8_t *packet, uint16_t size)
{
    ...
    case HCI_EVENT_PACKET:
        ...
        case SM_EVENT_PASSKEY_INPUT_NUMBER:
            ...
            smbox_trans_deal_passkey_input(&tmp32, event->con_handle);
