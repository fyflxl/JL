...
#define SI117X_I2C_ADDRESS     0xe0//0x70
...
int16_t Si117xWriteToRegister(uint8_t address, uint8_t value);
...
int16_t Si117xLoadBIOZRAM (void);
int16_t Si117xFlushFIFO(void);
int16_t Si117xBIOZTableQuery(uint8_t address);
int16_t Si117xBIOZTableSet(uint8_t address, uint8_t value);
int16_t Si117xInsertSynchMsg(uint8_t value);
int16_t Si117xSetPPGSlave(void);
