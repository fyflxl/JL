...
#else
        KEY_CHANGE_MODE, KEY_POWEROFF,		KEY_POWEROFF_HOLD,	KEY_NULL,	    KEY_BROADCAST_SW,			KEY_WIRELESS_AUTH_ENTER
#endif
    },
    [1] = {
        KEY_MUSIC_PP,	KEY_CALL_HANG_UP,	KEY_NULL,			KEY_NULL,		KEY_CALL_LAST_NO,	KEY_WIRELESS_AUTH_EXIT
    },
    [2] = {
...
const u16 fm_key_ad_table[KEY_AD_NUM_MAX][KEY_EVENT_MAX] = {
    ...
    [0] = {
        ...
        KEY_CHANGE_MODE, KEY_POWEROFF,		KEY_POWEROFF_HOLD,	KEY_NULL,		KEY_BROADCAST_SW,			KEY_WIRELESS_AUTH_ENTER
#else
        KEY_CHANGE_MODE, KEY_POWEROFF,		KEY_POWEROFF_HOLD,	KEY_NULL,		KEY_FM_SCAN_ALL_DOWN,			KEY_WIRELESS_AUTH_EXIT
#endif
    },
    [1] = {
...
const u16 linein_key_ad_table[KEY_AD_NUM_MAX][KEY_EVENT_MAX] = {
    ...
    [0] = {
        ...
        KEY_CHANGE_MODE, KEY_POWEROFF,		KEY_POWEROFF_HOLD,	KEY_NULL,		KEY_BROADCAST_SW,			KEY_WIRELESS_AUTH_ENTER
#else
        KEY_CHANGE_MODE, KEY_POWEROFF,		KEY_POWEROFF_HOLD,	KEY_NULL,		KEY_NULL,			KEY_WIRELESS_AUTH_EXIT
#endif
    },
    [1] = {
    ...
    [3] = {
        KEY_BROADCAST_SW,			KEY_VOL_DOWN,	KEY_VOL_DOWN,	KEY_NULL,		KEY_ENC_START,				KEY_NULL
    },
    [4] = {
...
const u16 music_key_ad_table[KEY_AD_NUM_MAX][KEY_EVENT_MAX] = {
    ...
    [0] = {
        ...
        KEY_CHANGE_MODE, KEY_POWEROFF,		KEY_POWEROFF_HOLD,	KEY_NULL,		KEY_BROADCAST_SW,			KEY_WIRELESS_AUTH_ENTER
#else
        KEY_CHANGE_MODE, KEY_POWEROFF,		KEY_POWEROFF_HOLD,	KEY_NULL,		KEY_MUSIC_PLAYE_REC_FOLDER_SWITCH,			KEY_WIRELESS_AUTH_EXIT
#endif
    },
    [1] = {
...
const u16 rtc_key_ad_table[KEY_AD_NUM_MAX][KEY_EVENT_MAX] = {
    ...
    [0] = {
        ...
        KEY_CHANGE_MODE, KEY_POWEROFF,		KEY_POWEROFF_HOLD,	KEY_NULL,		KEY_BROADCAST_SW,			KEY_WIRELESS_AUTH_ENTER
#else
        KEY_CHANGE_MODE, KEY_POWEROFF,		KEY_POWEROFF_HOLD,	KEY_NULL,		KEY_RTC_SW,			KEY_WIRELESS_AUTH_EXIT
#endif
    },
    [1] = {
        KEY_RTC_SW_POS,		KEY_NULL,		KEY_NULL,		KEY_NULL,		KEY_NULL,				KEY_NULL
    },
    [2] = {
        KEY_CHANGE_MODE,			KEY_NULL,		KEY_NULL,		KEY_NULL,		KEY_NULL,				KEY_NULL
    },
...
const u16 bc_mic_key_ad_table[KEY_AD_NUM_MAX][KEY_EVENT_MAX] = {
    //单击             //长按          //hold         //抬起            //双击                //三击
    [0] = {
#if TCFG_BROADCAST_ENABLE
        KEY_CHANGE_MODE, KEY_POWEROFF,		KEY_POWEROFF_HOLD,	KEY_NULL,		KEY_BROADCAST_SW,			KEY_WIRELESS_AUTH_ENTER
