...
const u16 bt_key_io_table[KEY_IO_NUM_MAX][KEY_EVENT_MAX] = {
    //单击             //长按          //hold         //抬起            //双击                //三击
    [0] = {
        KEY_NULL,   KEY_NULL	,	KEY_NULL,	KEY_NULL,	KEY_CHANGE_MODE,	KEY_NULL
    },
    [1] = {
        KEY_VOL_UP,	KEY_POWEROFF,	KEY_POWEROFF_HOLD,KEY_NULL,		KEY_MUSIC_NEXT,			KEY_NULL
    },
    [2] = {
        KEY_VOL_DOWN,	KEY_VOL_DOWN,	KEY_VOL_DOWN,	KEY_NULL,	KEY_MUSIC_PREV,			KEY_NULL
    },
    [3] = {
