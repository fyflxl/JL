...
#ifdef CONFIG_EFFECT_CORE_V2_ENABLE
#define   C_MAJOR       MODE_C_MAJOR
#define   Cshop_MAJOR   MODE_Cshop_MAJOR
#define   D_MAJOR       MODE_D_MAJOR
#define   Dshop_MAJOR   MODE_Dshop_MAJOR
#define   E_MAJOR       MODE_E_MAJOR
#define   F_MAJOR       MODE_F_MAJOR
#define   Fshop_MAJOR   MODE_Fshop_MAJOR
#define   G_MAJOR       MODE_G_MAJOR
#define   Gshop_MAJOR   MODE_Gshop_MAJOR
#define   A_MAJOR       MODE_A_MAJOR
#define   Ashop_MAJOR   MODE_Ashop_MAJOR
#define   B_MAJOR       MODE_B_MAJOR
#endif
...
static void soundcard_app_set_pitch_mode(u8 mode)
{
    ...
    if (SOUNDCARD_MODE_ELECTRIC == __this->mode) {
        ...
        parm.mode = electric_tab[__this->electric];
...
void soundcard_event_deal(struct sys_event *event)
{
    ...
    case KEY_SOUNDCARD_SLIDE_MUSIC_VOL:
        ...
        audio_dig_vol_group_vol_set(sys_digvol_group, "music_a2dp",     AUDIO_DIG_VOL_ALL_CH, __this->music_vol);
        audio_dig_vol_group_vol_set(sys_digvol_group, "music_linein",   AUDIO_DIG_VOL_ALL_CH, __this->music_vol);
        audio_dig_vol_group_vol_set(sys_digvol_group, "music_pc", 	    AUDIO_DIG_VOL_ALL_CH, __this->music_vol);
        break;
