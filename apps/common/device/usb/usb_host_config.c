...
static u8 ep0_dma[USB_MAX_HW_NUM][64 + 4] SEC(.usb.data.bss.host_mem) __attribute__((aligned(4)));
static u8 ep1_dma[USB_MAX_HW_NUM][64 * 2 + 4] SEC(.usb.data.bss.host_mem) __attribute__((aligned(4)));
static u8 ep2_dma[USB_MAX_HW_NUM][64 * 2 + 4] SEC(.usb.data.bss.host_mem) __attribute__((aligned(4)));
static u8 ep3_dma[USB_MAX_HW_NUM][64 * 2 + 4] SEC(.usb.data.bss.host_mem) __attribute__((aligned(4)));
static u8 ep4_dma[USB_MAX_HW_NUM][64 * 2 + 4] SEC(.usb.data.bss.host_mem) __attribute__((aligned(4)));
#else
#if defined(FUSB_MODE) && FUSB_MODE
static u8 msd_h_dma_buffer[2][64 + 4] SEC(.usb.data.bss.host_mem) __attribute__((aligned(4)));
#elif defined(FUSB_MODE) && (FUSB_MODE == 0)
static u8 msd_h_dma_buffer[2][512] SEC(.usb.data.bss.host_mem) __attribute__((aligned(4)));
#else
