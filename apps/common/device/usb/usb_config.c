...
static u8 ep0_dma_buffer[EP0_SETUP_LEN]     __attribute__((aligned(4)));
...
static u8 usb_dma_buf[USB_DMA_BUF_MAX_SIZE] SEC(.usb.data.bss.exchange) __attribute__((aligned(8)));
