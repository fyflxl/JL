...
#if ((RCSP_MODE || SMART_BOX_EN)) && (defined(CONFIG_WATCH_CASE_ENABLE))
...
#if (((defined CONFIG_CPU_BR25) || (defined CONFIG_CPU_BR23)) && TCFG_USER_TWS_ENABLE) || TCFG_USER_BLE_ENABLE
...
void testbox_update_msg_handle(int msg)
{
    ...
    case MSG_BT_UPDATE_LOADER_DOWNLOAD_START:
        if (UPDATE_MODULE_IS_SUPPORT(UPDATE_BT_LMP_EN)) {
            /* #if ((RCSP_MODE || SMART_BOX_EN)) && (defined(CONFIG_WATCH_CASE_ENABLE)) */
            /*             app_rcsp_task_prepare(0, SMARTBOX_TASK_ACTION_WATCH_TRANSFER, 0); */
            /* #endif */
