...
static u8 rcsp_rtc_alarm_deal(void *priv, u8 *p, u8 len)
{
    ...
    case E_ALARM_UNACTIVE:
        ...
        rcsp_function_update(RTC_FUNCTION_MASK, BIT(RTC_INFO_ATTR_RTC_ALRAM_UNACTIVE));
        break;
    default:
...
void rcsp_rtc_msg_deal(int msg)
{
    ...
    case (int)-1 :
        ...
        rcsp_function_update(RTC_FUNCTION_MASK, BIT(RTC_INFO_ATTR_RTC_ALRAM_ACTIVE));
        break;
    }
}
...
static void rtc_ring_stop_handle(void)
{
    ...
    rcsp_function_update(RTC_FUNCTION_MASK, BIT(RTC_INFO_ATTR_RTC_ALRAM_STRUCTURE) | BIT(RTC_INFO_ATTR_RTC_ALRAM_UNACTIVE));
    rcsp_function_update(RTC_FUNCTION_MASK, BIT(RTC_INFO_ATTR_RTC_ALRAM));
