...
int set_setting_extra_handle(RCSP_SETTING_OPT *setting_opt_hdl, void *setting_data, void *param)
{
...
int get_setting_extra_handle(RCSP_SETTING_OPT *setting_opt_hdl, void *setting_data, void *param)
{
